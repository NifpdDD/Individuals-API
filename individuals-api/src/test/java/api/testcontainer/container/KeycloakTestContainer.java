...
import static api.testcontainer.util.Setting.realmInitPath;

public class KeycloakTestContainer {

    public static final GenericContainer keycloakTestContainer = new GenericContainer<>(DockerImageName.parse("quay.io/keycloak/keycloak:26.2"))
